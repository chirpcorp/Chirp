...
export default function SharePopup({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" onClick={onClose}>
      <div 
        className="mx-4 w-80 max-w-sm rounded-xl border border-dark-4 bg-dark-2 p-6"
      ...
      >
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <button 
            onClick={onClose}
            className="text-gray-1 transition-colors hover:text-light-1"
          >
        ...
        <div className="mb-6">
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg bg-dark-3 p-3 transition-colors hover:bg-dark-4"
          >
        ...
        <div className="space-y-3">
          <p className="mb-3 text-body-semibold text-light-1">Share to:</p>
          
          {/* WhatsApp */}
          <button
            onClick={shareToWhatsApp}
            className="flex w-full items-center gap-3 rounded-lg p-3 transition-colors hover:bg-dark-3"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg p-3 transition-colors hover:bg-dark-3"
          >
            <div className="flex size-10 items-center justify-center rounded-full border border-gray-600 bg-black">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg p-3 transition-colors hover:bg-dark-3"
          >
            <div className="bg-blue-600 flex size-10 items-center justify-center rounded-full">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg p-3 transition-colors hover:bg-dark-3"
          >
            <div className="bg-blue-700 flex size-10 items-center justify-center rounded-full">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-lg p-3 transition-colors hover:bg-dark-3"
          >
            <div className="bg-blue-500 flex size-10 items-center justify-center rounded-full">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
